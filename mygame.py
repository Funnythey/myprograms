...
while run:
    ...
    background = pygame.transform.scale(background, (win_width - border_thick, win_height - menu_thick)) # sets it to the size of the window - borders
    ...
    coins_counter = score_font.render(f'Coins: '+ str(score), False, (100,100,100))
    win.blit(coins_counter, (border_thick*2,border_thick * 2))
    level_counter = score_font.render(f'Level: '+ str(level), False, (100,100,100))
